...
import { ShoppingBag, Search, X, Heart, User, LogOut, Truck, Home, ShoppingCart, ChevronDown, Moon, Sun } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-14 md:h-16">
            ...
            <div className="hidden lg:flex items-center gap-2 z-10 flex-shrink-0">
              <Link to="/" className="flex items-center gap-2">
                <img src={logo} alt="Saree Store" className="h-16 w-auto" />
              </Link>
            </div>
            ...
            <div className="absolute left-1/2 -translate-x-1/2 lg:hidden">
              <Link to="/" className="flex items-center">
                <img src={logo} alt="Saree Store" className="h-14 w-auto" />
              </Link>
            </div>
